...
# q51 = Question.create(
#   title: 'What do you mean by sessions in Rails? In what circumstances do you need to use sessions? Explain.',
#   keyword: 'Ruby on Rails',
#   is_premium: false
#   )
